...
describe Archaeopteryx::Drum, "forcing the :external_strategy proc to determine which notes to play (by setting :strategy_select to 'L{ |strategies| strategies[0] }')" do
